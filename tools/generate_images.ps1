...
$Manifest = @(
  @{ f='symbol_aerion.png';    s='1024x1024'; t=$true;  p=('Head-and-shoulders portrait of an original heroic transforming robot sky-sentinel, azure blue and brushed-silver armor, glowing cyan eyes, jet-intake shoulders, ' + $Style + ', ' + $Guard) },
  @{ f='symbol_voltrix.png';   s='1024x1024'; t=$true;  p=('Head-and-shoulders portrait of an original rugged transforming robot storm-charger, crimson and burnt-orange armor, crackling amber eyes, turbine chest, ' + $Style + ', ' + $Guard) },
  @{ f='symbol_nimbus.png';    s='1024x1024'; t=$true;  p=('Head-and-shoulders portrait of an original noble transforming robot cloud-carrier, ivory-white and gold armor, warm golden eyes, winged helm, ' + $Style + ', ' + $Guard) },
  @{ f='symbol_razorwing.png'; s='1024x1024'; t=$true;  p=('Head-and-shoulders portrait of an original sinister villain transforming robot interceptor, violet and gunmetal-black angular armor, piercing red eyes, blade-like wing crest, ' + $Style + ', ' + $Guard) },
